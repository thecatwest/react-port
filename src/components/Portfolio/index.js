...
function Portfolio() {
  const portfolio = [
    ...
    },
    {
      id: 2,
      title: "Daily Planner",
      link: "https://thecatwest.github.io/work-day-scheduler/",
      github: "https://github.com/thecatwest/work-day-scheduler",
      image: require("../../assets/portfolio/workday-scheduler.png").default,
      description:
        "An app that allows users to schedule and save their workday.",
    },
    {
      id: 3,
      title: "Trade Secret",
